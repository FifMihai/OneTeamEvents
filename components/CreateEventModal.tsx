...
import { X, Calendar, MapPin, Type, Tag, AlignLeft } from "lucide-react";
...
export default function CreateEventModal({ isOpen, onClose, onAdd }: { isOpen: boolean, onClose: () => void, onAdd: (event: any) => void }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center p-4 z-[60] backdrop-blur-md">
      <div className="bg-white dark:bg-[#1e1e1e] rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden relative animate-in fade-in zoom-in duration-200 text-gray-800 dark:text-white">
        
        <div className="p-6 border-b border-gray-100 dark:border-gray-800 flex justify-between items-center">
          <h2 className="text-2xl font-bold">Creează Eveniment</h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <div className="relative text-gray-400 focus-within:text-blue-500">
              <Type className="absolute left-3 top-3 w-4 h-4 transition-colors" />
              <input 
                required
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="relative text-gray-400 focus-within:text-blue-500">
                <Calendar className="absolute left-3 top-3 w-4 h-4 transition-colors" />
                <input 
                  type="date"
                  required
            ...
            <div>
              ...
              <div className="relative text-gray-400 focus-within:text-blue-500">
                <Tag className="absolute left-3 top-3 w-4 h-4 transition-colors" />
                <select 
          ...
          <div>
            ...
            <div className="relative text-gray-400 focus-within:text-blue-500">
              <MapPin className="absolute left-3 top-3 w-4 h-4 transition-colors" />
              <input 
                className="w-full pl-10 pr-4 py-2 border rounded-lg bg-transparent dark:border-gray-700 outline-none focus:ring-2 focus:ring-blue-500" 
